...
export const TableConfig = (t) => ({
  PT: {
    searchColumns: (props) => [
      {
        ...
        //Header: t("ES_INBOX_UNIQUE_APPLICATION_NO"),
    ...
    ], // change the keys for localization in Header of this method
    inboxColumns: (props) => [
      // {
      //   Header: t("ES_INBOX_UNIQUE_PROPERTY_ID"),
      //   // Header: t("PTR_INBOX_UNIQUE_APPLICATION_NO"),
      //   Cell: ({ row }) => {
      //     console.log("$%^row: ", row)
      //     return (
      //       <div>
      ...
      },
      {
        ...
        Header: t("Status"),
        // Header: t("PTR_INBOX_SLA_DAYS_REMAINING"),
